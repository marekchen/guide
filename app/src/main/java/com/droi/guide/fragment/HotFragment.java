...
/*        ListView lv = (ListView) view.findViewById(R.id.lv);//得到ListView对象的引用 *//*为ListView设置Adapter来绑定数据*//*
        lv.setAdapter(new ArrayAdapter<String>(this.getActivity(),
                android.R.layout.simple_list_item_1, strs));*/
        RecyclerView mRecyclerView = (RecyclerView) view1.findViewById(R.id.lv);
