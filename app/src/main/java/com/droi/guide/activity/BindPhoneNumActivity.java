...
public class BindPhoneNumActivity extends FragmentActivity implements OnFragmentInteractionListener, BackHandlerInterface {
    ...
    private static void displayBindPhoneNumFragment() {
        ...
        transaction.replace(R.id.bind_phone_container, bindNumFragment);
        transaction.commit();
    }

    public static void displayConfirmPinFragment() {
        FragmentTransaction transaction = fm.beginTransaction();
        Fragment confirmPinFragment = ConfirmPinFragment.newInstance();
        transaction.replace(R.id.bind_phone_container, confirmPinFragment);
        transaction.commit();
    }
